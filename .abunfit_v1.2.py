...
def main():
		        ...
		        [model<1/2/...>] -- Name of the model. Currently available models: \n \
		                            ...
		                            == Nomoto et al. (2013)\n \
		                             ...
		                             = All SNe (SNcc+PISNe): 11 - 300 M_sun\n \
		                              - N13_SNe_0\n\n \
		EXAMPLE: ./abunfit.py cluster/average_abun_clusters.out 2 -2.35 Iwamoto_WDD2 Nomoto_0.02\n\n \
	...
	elif (input_mod_1 == "Nomoto_0") or (input_mod_1 == "Nomoto_0.001") or \
		(input_mod_1 == "Nomoto_0.004") or (input_mod_1 == "Nomoto_0.02") or \
		(input_mod_1 == "Nomoto_0_undecayed") or (input_mod_1 == "Nomoto_0.001_undecayed") or \
		(input_mod_1 == "Nomoto_0.004_undecayed") or (input_mod_1 == "Nomoto_0.02_undecayed") or \
		(input_mod_1 == "Chieffi_0") or (input_mod_1 == "Chieffi_1E-6") or \
		(input_mod_1 == "Chieffi_1E-4") or (input_mod_1 == "Chieffi_1E-3") or \
		(input_mod_1 == "Chieffi_6E-3") or (input_mod_1 == "Chieffi_2E-2"):
	...
	if number_of_models>1:
		...
		elif (input_mod_2 == "Nomoto_0") or (input_mod_2 == "Nomoto_0.001") or \
			(input_mod_2 == "Nomoto_0.004") or (input_mod_2 == "Nomoto_0.02") or \
			(input_mod_2 == "Nomoto_0_undecayed") or (input_mod_2 == "Nomoto_0.001_undecayed") or \
			(input_mod_2 == "Nomoto_0.004_undecayed") or (input_mod_2 == "Nomoto_0.02_undecayed") or \
			(input_mod_2 == "Chieffi_0") or (input_mod_2 == "Chieffi_1E-6") or \
			(input_mod_2 == "Chieffi_1E-4") or (input_mod_2 == "Chieffi_1E-3") or \
			(input_mod_2 == "Chieffi_6E-3") or (input_mod_2 == "Chieffi_2E-2"):
	...
	if number_of_models>2:
		...
		elif (input_mod_3 == "Nomoto_0") or (input_mod_3 == "Nomoto_0.001") or \
			(input_mod_3 == "Nomoto_0.004") or (input_mod_3 == "Nomoto_0.02") or \
			(input_mod_3 == "Nomoto_0_undecayed") or (input_mod_3 == "Nomoto_0.001_undecayed") or \
			(input_mod_3 == "Nomoto_0.004_undecayed") or (input_mod_3 == "Nomoto_0.02_undecayed") or \
			(input_mod_3 == "Chieffi_0") or (input_mod_3 == "Chieffi_1E-6") or \
			(input_mod_3 == "Chieffi_1E-4") or (input_mod_3 == "Chieffi_1E-3") or \
			(input_mod_3 == "Chieffi_6E-3") or (input_mod_3 == "Chieffi_2E-2"):
	...
	if number_of_models>3:
		...
		elif (input_mod_4 == "Nomoto_0") or (input_mod_4 == "Nomoto_0.001") or \
			(input_mod_4 == "Nomoto_0.004") or (input_mod_4 == "Nomoto_0.02") or \
			(input_mod_4 == "Nomoto_0_undecayed") or (input_mod_4 == "Nomoto_0.001_undecayed") or \
			(input_mod_4 == "Nomoto_0.004_undecayed") or (input_mod_4 == "Nomoto_0.02_undecayed") or \
			(input_mod_4 == "Chieffi_0") or (input_mod_4 == "Chieffi_1E-6") or \
			(input_mod_4 == "Chieffi_1E-4") or (input_mod_4 == "Chieffi_1E-3") or \
			(input_mod_4 == "Chieffi_6E-3") or (input_mod_4 == "Chieffi_2E-2"):
