...
def main():
	...
	if len(sys.argv) < 4:
		...
		PROGRAM: abun_modified.py\n\n \
		SYNOPSIS: ./abun_modified.py [input_file] [number_of_models] [alpha] [SNe_model_1] [SNe_model_2] ... \n\n \
		...
		ARGUMENTS: \n\n \
		        ...
		        [number_of_models] -- Integer (from 2 to 4) indicating the number of \n \ 			                              models to be fitted simultaneously (min: 2, max: 4).\n \
		        ...
		        [model<1/2/...>] -- Name of the model. Currently available models: \n \
		                            ...
		                            - 0.004\n \
		                            - 0.02\n\n \
		EXAMPLE: ./abun_modified.py average_abun_clusters.out 2 -2.35 Iwamoto_WDD2 0.02\n\n \
	...
	if number_of_models>4:
		sys.exit("Error: This program cannot fit more than 4 models simultaneously... Sorry :(")
	...
	if (input_mod_1 == "Iwamoto_W7") or (input_mod_1 == "Iwamoto_W70") or \
		...
		(input_mod_1 == "Iwamoto_W7_undecayed") or (input_mod_1 == "Iwamoto_W70_undecayed") or \
		(input_mod_1 == "Iwamoto_WDD1_undecayed") or (input_mod_1 == "Iwamoto_WDD2_undecayed") or \
		(input_mod_1 == "Iwamoto_WDD3_undecayed") or (input_mod_1 == "Iwamoto_CDD1_undecayed") or \
		(input_mod_1 == "Iwamoto_CDD2_undecayed") or \
		...
		(input_mod_1 == "Badenes_DDTe_undecayed") or (input_mod_1 == "Badenes_DDTf_undecayed"):
	...
	if (input_mod_2 == "Iwamoto_W7") or (input_mod_2 == "Iwamoto_W70") or \
		...
		(input_mod_2 == "Iwamoto_W7_undecayed") or (input_mod_2 == "Iwamoto_W70_undecayed") or \
		(input_mod_2 == "Iwamoto_WDD1_undecayed") or (input_mod_2 == "Iwamoto_WDD2_undecayed") or \
		(input_mod_2 == "Iwamoto_WDD3_undecayed") or (input_mod_2 == "Iwamoto_CDD1_undecayed") or \
		(input_mod_2 == "Iwamoto_CDD2_undecayed") or \
		(input_mod_2 == "Badenes_DDTa_undecayed") or (input_mod_2 == "Badenes_DDTb_undecayed") or \
		(input_mod_2 == "Badenes_DDTc_undecayed") or (input_mod_2 == "Badenes_DDTd_undecayed") or \
		(input_mod_2 == "Badenes_DDTe_undecayed") or (input_mod_2 == "Badenes_DDTf_undecayed"):
	...
	if number_of_models>2:
		if (input_mod_3 == "Iwamoto_W7") or (input_mod_3 == "Iwamoto_W70") or \
			...
			(input_mod_3 == "Iwamoto_W7_undecayed") or \
			(input_mod_3 == "Iwamoto_W70_undecayed") or \
			(input_mod_3 == "Iwamoto_WDD1_undecayed") or \
			(input_mod_3 == "Iwamoto_WDD2_undecayed") or \
			(input_mod_3 == "Iwamoto_WDD3_undecayed") or \
			(input_mod_3 == "Iwamoto_CDD1_undecayed") or \
			(input_mod_3 == "Iwamoto_CDD2_undecayed") or \
			...
			(input_mod_3 == "Badenes_DDTf_undecayed"):
	...
	if number_of_models>3:
		if (input_mod_4 == "Iwamoto_W7") or (input_mod_4 == "Iwamoto_W70") or \
			...
			(input_mod_4 == "Iwamoto_W7_undecayed") or \
			(input_mod_4 == "Iwamoto_W70_undecayed") or \
			(input_mod_4 == "Iwamoto_WDD1_undecayed") or \
			(input_mod_4 == "Iwamoto_WDD2_undecayed") or \
			(input_mod_4 == "Iwamoto_WDD3_undecayed") or \
			(input_mod_4 == "Iwamoto_CDD1_undecayed") or \
			(input_mod_4 == "Iwamoto_CDD2_undecayed") or \
			...
			(input_mod_4 == "Badenes_DDTf_undecayed"):
...
def integrate_SNcc( metal, alpha , elem_name ):
  ...
  #for z in metal:     
	...
	for el in elem_name:
		data_mod=numpy.loadtxt('integrate/nomoto/'+str(metal)+'/'+str(el)+'.txt') #Open file
